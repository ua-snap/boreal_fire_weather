...
# echo
# #ais the following link does not work
...
# #ais so Jeremy just gave me an alternative link to accessing historical fire data
# # downloaded manually - https://www.frames.gov/catalog/10465
...
GDB_NAME=$(basename -- a0000000d.gdbtable) 
#ais GDB_NAME=$(basename -- *.gdb)
