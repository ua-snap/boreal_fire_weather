...
root_dir = Path("/Users/AISpiers/dev/boreal_wildfire_feedbacks/wildfire_analysis") # Path(h.get_root_dir()) #ais
...
fn = dataframes_dir / 'cffdrs_annual_stats.csv' #cffdrs_annual_stats_kenn.csv
